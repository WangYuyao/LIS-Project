...
class Engine:
    def __init__(self, args, logger):
        ...
        if self.args.train.dataset == "OpenLid":
            ...
            if self.mode == "train":
                self.data_path = self.args.train.data_path
                self.dataset = PushT(self.data_path)
            else:
                self.data_path = self.args.test.data_path
                self.dataset = PushT(self.data_path).get_validation_dataset()
    ...
    def online_test(self):
        ...
        if self.args.train.dataset == "OpenLid":
            ...
            if self.mode == "train":
                self.data_path = self.args.train.data_path
                test_dataset = PushT(self.data_path)
            else:
                self.data_path = self.args.test.data_path
                test_dataset = PushT(self.data_path).get_validation_dataset()
